...
const Product1 = () => {
  return (
    <div id='product1-details' className='min-h-[60vh] dark:bg-[#3b3a3a]'>
            <div className='my-3 p-4 flex items-center justify-between'>
        <h1 className='text-2xl text-gray-600 tracking-wider font-extrabold font-serif'>Product-1 Details Report</h1>
    </div>
    ...
    <table className='h-auto border bg-white drop-shadow-2xl overflow-x-scroll block whitespace-nowrap dark:bg-[#1c1616]'>
            ...
            <tbody className='dark:bg-[#1c1616]'>
